...
import { ProdutoItem } from '.dados/ProdutoItem';
...
export default function ProdutoLista({ navigation }){
    ...
    return (
        <View style={styles.container}>
            ...
            contentContainerStyle= {styles.itensContainer} keyExtractor={myKeyExtractor}
            renderItem={ ({item}) =>
            <ProdutoItem onDelete = {() => excluirProduto(item.codigo)}
            produto= {item} />
            }
            />
